...
class OphCoPatientsatisfactionModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphCoPatientsatisfaction.models.*',
			'OphCoPatientsatisfaction.components.*',
		));

		$this->moduleShortSuffix = "patientsatisfaction";
	}
